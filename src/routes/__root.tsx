  ...
  head: () => ({
    meta: [
      ...
      { title: "Atlas — Life OS" },
      {
        name: "description",
        content:
          "Atlas é um sistema operacional pessoal para acompanhar sua evolução financeira, pessoal e profissional.",
      },
      { name: "author", content: "Atlas" },
      { property: "og:title", content: "Atlas — Life OS" },
      {
        property: "og:description",
        content:
          "Sistema operacional pessoal para acompanhar sua evolução financeira, pessoal e profissional.",
      },
